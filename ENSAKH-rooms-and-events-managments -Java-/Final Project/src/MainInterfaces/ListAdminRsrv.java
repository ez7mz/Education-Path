...
public class ListAdminRsrv extends JFrame{
	
	public String Date;
	String[] Head = {"Id", "Nom", "Prenom", "Fonction","Reservation Date", "Salle Num"};
	JTable Tab;
	
	public ListAdminRsrv(String Date) {
		super("Admin Reservation List");
		this.Date = Date;
	...
	private ResultSet SelectFrom() {
		...
		String req = "select admins.IdAdmin, Nom, Prenom, Fonction, ResvDate, SalleNum from reservations, admins WHERE reservations.IdAdmin!=0 AND reservations.IdAdmin=admins.IdAdmin AND ResvDate='"+Date+"'";
		try {
