...
public class ListProfOrg extends JFrame{
	public String Date;
	String[] Head = {"Id", "Nom", "Prenom", "Departement","Event Date", "Salle Num", "Sujet"};
	JTable Tab;
	
	public ListProfOrg(String Date) {
		super("Profs Events List");
		this.Date = Date;
	...
	private ResultSet SelectFrom() {
		...
		String req = "SELECT professeurs.IdProf, Nom, Prenom, Departement, EventDate, SalleNum, Sujet FROM events, professeurs WHERE events.IdProf!=0 AND events.IdProf=professeurs.IdProf AND EventDate='"+Date+"'";
		try {
